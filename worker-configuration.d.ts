/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b6c3c29c30c5e64563c1001999e7e7c5)
// Runtime types generated with workerd@1.20260310.1 2026-02-12 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "EventCancellationExpirationJobDurableObject" | "StreamHubDurableObject";
	}
	interface StagingEnv {
		DB: D1Database;
		ASSETS: Fetcher;
		AUTHORIZATION_SIGNING_SECRET: string;
		CANCELLATION_PUSH_NOTIFICATION_URL: string;
		...
		CORS_VARY: string;
		GO_LIVE_PUSH_NOTIFICATION_URL: string;
		NODE_ENV: string;
		PUSH_API_KEY: string;
		PUSH_APP_ID: string;
		PUSH_BADGE_URL: string;
		PUSH_ICON_URL: string;
		TZ: string;
		X_POWERED_BY: string;
		EVENT_CANCELLATION_EXPIRATION_JOB: DurableObjectNamespace<import("./src/index").EventCancellationExpirationJobDurableObject>;
		STREAM_HUB: DurableObjectNamespace<import("./src/index").StreamHubDurableObject>;
	}
	interface Env {
		DB: D1Database;
		ASSETS: Fetcher;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTHORIZATION_SIGNING_SECRET" | "CANCELLATION_PUSH_NOTIFICATION_URL" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_D1_TOKEN" | "CLOUDFLARE_DATABASE_ID" | "CORS_ALLOWED_HEADERS" | "CORS_ALLOWED_METHODS" | "CORS_ALLOWED_ORIGINS" | "CORS_VARY" | "GO_LIVE_PUSH_NOTIFICATION_URL" | "NODE_ENV" | "PUSH_API_KEY" | "PUSH_APP_ID" | "PUSH_BADGE_URL" | "PUSH_ICON_URL" | "TZ" | "X_POWERED_BY">> {}
}
