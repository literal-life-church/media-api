/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d7ce349fe2406e3177a22ab0164aee4b)
// Runtime types generated with workerd@1.20260310.1 2026-02-12 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "EventCancellationDurableObject";
	}
	interface Env {
		DB: D1Database;
		ASSETS: Fetcher;
		EVENT_CANCELLATION_DO: DurableObjectNamespace<import("./src/index").EventCancellationDurableObject>;
	}
}
