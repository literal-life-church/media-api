...
// Authorization
export const AUTHORIZATION_SIGNING_SECRET = EnvironmentVariableDataSource("AUTHORIZATION_SIGNING_SECRET") || "";
...
// CORS
export const CORS_ALLOWED_HEADERS = EnvironmentVariableDataSource("CORS_ALLOWED_HEADERS") || "";
export const CORS_ALLOWED_ORIGINS = EnvironmentVariableDataSource("CORS_ALLOWED_ORIGINS") || "";
export const CORS_ALLOWED_METHODS = EnvironmentVariableDataSource("CORS_ALLOWED_METHODS") || "";
export const CORS_VARY = EnvironmentVariableDataSource("CORS_VARY") || "";
export const X_POWERED_BY = EnvironmentVariableDataSource("X_POWERED_BY") || "";
