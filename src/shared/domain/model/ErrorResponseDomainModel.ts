...
export function ErrorResponseDomainModel(code: number, message: string, name: string) {
    return Obj({
        ...
        internalMessage: Str({
            ...
            description: "An optional internal message that provides more detailed information about the error for debugging purposes. This message should not be exposed to end users, as it may contain sensitive information or technical details that are not relevant to them. This property is only visible in development environments.",
            required: false
        }),
        message: Str({
            example: message,
